...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(company-lsp lsp-ui lsp-mode flycheck-clj-kondo lua-mode merlin tuareg doom-modeline ox-reveal elm-mode ob-restclient slime-company slime sql-indent centaur-tabs company-go htmlize dockerfile-mode helm-posframe posframe go-mode company-distel diminish moody flycheck-nim nim-mode ac-geiser geiser flycheck-rust window-purpose w3m fill-column-indicator circe org spaceline-config eyebrowse helm-purpose scad-preview scad-mode spaceline neotree projectile which-key helm doom-themes use-package)))
