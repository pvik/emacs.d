...
;; ## added by OPAM user-setup for emacs / ocp-indent ## 514f101f5af00fa2a4dfd3bb7214016a ## you can edit, but keep this line
;; Load ocp-indent from its original switch when not found in current switch
(when (not (member "ocp-indent" opam-tools-installed))
  (autoload 'ocp-setup-indent "/home/elric/.opam/base_5_3_0/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Tuareg mode")
  (autoload 'ocp-indent-caml-mode-setup "/home/elric/.opam/base_5_3_0/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Caml mode")
  (add-hook 'tuareg-mode-hook 'ocp-setup-indent t)
  (add-hook 'caml-mode-hook 'ocp-indent-caml-mode-setup  t)
  (setq ocp-indent-path "/home/elric/.opam/base_5_3_0/bin/ocp-indent"))
